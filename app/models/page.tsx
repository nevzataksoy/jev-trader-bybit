...
const text = {
  tr: {
    ...
    signal: "Sinyal", revision: "Revizyon", status: "Durum", reason: "Neden", metrics: "Metrikler", setupReadiness: "Kurulum / hazırlık", allocation: "Tahsis", edgeRisk: "Avantaj / risk", evidence: "Kanıt özeti", blockers: "Engelleyen filtreler", rationale: "Politika gerekçesi", details: "Ayrıntılar", runtime: "Runtime", executionEngine: "Exchange motoru", availableEngines: "Kayıtlı motorlar", cycle: "Çevrim", completed: "Tamamlandı", model: "Jev modeli", current: "Mevcut", targetLabel: "Hedef", delta: "Fark", expectedEdge: "Net avantaj", opportunity: "Fırsat", riskBudget: "Portföy risk bütçesi", readinessScore: "Hazırlık puanı", signalState: "Sinyal durumu", regime: "Rejim", direction: "Yön", quality: "Kalite", liquidity: "Likidite", disorder: "Düzensizlik", falseBreakout: "Sahte kırılım", rowsPerPage: "Sayfa başına", previous: "Önceki", next: "Sonraki", page: "Sayfa", records: "kayıt",
  },
  en: {
...
const decisionValueLabels: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    pending: "Pending", confirmed: "Confirmed", expired: "Expired", invalidated: "Invalidated", JEV_NO_ENTRY: "Jev: no entry", PENDING_CLOSE: "Waiting for close", PENDING_RETEST: "Waiting for retest", STRUCTURE_REJECTED: "Structure rejected", DIRECTIONAL_EDGE_LOW: "Directional edge low", SETUP_QUALITY_LOW: "Setup quality low", NET_EDGE_LOW: "Net edge low", LIQUIDITY_LOW: "Liquidity low", DISORDERLY_MARKET: "Disorderly market", RISK_BUDGET_ZERO: "Risk budget zero", ALLOCATION_DEADBAND: "Allocation delta below threshold", NO_ALLOCATION_INTENT: "No allocation intent", TARGET_ROOM_LOW: "Target room too small after costs", resistance: "Resistance", atr_projection: "ATR projection",
  },
};
