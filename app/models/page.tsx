...
const text = {
  tr: {
    ...
    signal: "Sinyal", revision: "Revizyon", status: "Durum", reason: "Neden", metrics: "Metrikler", setupReadiness: "Kurulum / hazırlık", allocation: "Tahsis", edgeRisk: "Avantaj / risk", evidence: "Kanıt özeti", blockers: "Engelleyen filtreler", diagnostics: "Tanısal sinyaller", rationale: "Politika gerekçesi", details: "Ayrıntılar", runtime: "Runtime", executionEngine: "Exchange motoru", availableEngines: "Kayıtlı motorlar", cycle: "Çevrim", completed: "Tamamlandı", model: "Jev modeli", current: "Mevcut", targetLabel: "Hedef", delta: "Fark", expectedEdge: "Net avantaj", opportunity: "Fırsat", candidatePlan: "Aday plan", afterCostRoom: "Maliyet sonrası alan", riskBudget: "Portföy risk bütçesi", readinessScore: "Hazırlık puanı", signalState: "Sinyal durumu", regime: "Rejim", direction: "Yön", quality: "Kalite", liquidity: "Likidite", disorder: "Düzensizlik", falseBreakout: "Sahte kırılım", rowsPerPage: "Sayfa başına", previous: "Önceki", next: "Sonraki", page: "Sayfa", records: "kayıt",
  },
  en: {
