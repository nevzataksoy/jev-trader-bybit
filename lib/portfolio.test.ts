...
describe("portfolio decision context", () => {
  ...
  it("runs risk-reduction sells before the strongest buy", () => {
    ...
    const decisions: JevDecision[] = [
      { asset: "BTC", action: "buy", confidence: 0.9, probabilities: { buy: 0.9, hold: 0.08, sell: 0.02 }, currentAllocationPct: 20, targetAllocationPct: 30, rebalanceDeltaPct: 10, policyReason: "test", judgments },
      { asset: "ETH", action: "sell", confidence: 0.75, probabilities: { buy: 0.05, hold: 0.1, sell: 0.85 }, currentAllocationPct: 20, targetAllocationPct: 10, rebalanceDeltaPct: -10, policyReason: "test", judgments },
      { asset: "XAUT", action: "hold", confidence: 0.95, probabilities: { buy: 0.02, hold: 0.96, sell: 0.02 }, currentAllocationPct: 0, targetAllocationPct: 0, rebalanceDeltaPct: 0, policyReason: "test", judgments },
    ];
