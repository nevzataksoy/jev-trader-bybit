...
const market = {
  ...
  atr_14_1h_pct: 1.5,
  atr_14_4h_pct: 2.5,
  atr_15m_percentile: 0.5,
  support_zone_low: 98.5,
  support_zone_high: 99.5,
  support_strength: 0.8,
  resistance_zone_low: 102,
  resistance_zone_high: 103,
  resistance_strength: 0.7,
  secondary_resistance_price: 105,
  support_distance_pct: 0.5,
  resistance_distance_pct: 2,
  orderbook_wall_bias: 0.1,
  orderbook_imbalance: 0.1,
  bid_wall_persistence: 0.75,
  ask_wall_persistence: 0.5,
  depth_ratio: 1.1,
  trade_flow_imbalance: 0.05,
  open_interest_change_1h_pct: 0.2,
  funding_rate_latest_pct: 0.01,
